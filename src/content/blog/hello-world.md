...
This site is built with [Astro](https://astro.build) and hosted on CloudFlare Pages. All content is written in Markdown files that get compiled to static HTML.
